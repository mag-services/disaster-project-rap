...
resources_needed <- staple_damage %>%
  ...
  mutate(
    ...
    # Water bottles and tinned fish (immediate response)
  ...
  ungroup() %>%
  select(Region, num_households_affected, water, tin_fish, island_cabbage_cuttings, taro_seedlings, kumala_cuttings, manioc_cuttings, yam_cuttings)
...
reactable(
  ...
  columnGroups = list(
    ...
    colGroup(name = "Immediate Response (Water & Food)", columns = c("water", "tin_fish")),
