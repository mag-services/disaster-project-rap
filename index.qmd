...
resources_needed <- education_with_config_resources %>%
  ...
  ungroup() %>%
  select(Region, contains("tents"), contains("solar_lamps"))
...
reactable(
  ...
  columnGroups = list(
    colGroup(name = "Region", columns = c("Region")),
    colGroup(name = "ECCE", columns = c("ecce_tents", "ecce_solar_lamps")),
    colGroup(name = "Primary", columns = c("primary_tents", "primary_solar_lamps")),
    colGroup(name = "Secondary", columns = c("secondary_tents", "secondary_solar_lamps")),
    colGroup(name = "Totals", columns = c("total_tents", "total_solar_lamps"))
  ),
  striped = TRUE,
  highlight = TRUE,
  bordered = TRUE,
